...
<div class="container">
    <div class="content default_shadow">
        <p style="margin: 0; font-size: 30px; margin-bottom: 30px">Forgot your password ?</p>
        <input class="default_input" placeholder="Email" type="text">

        <p>We will send you a verification email to the gmail you mentioned above.</p>
